...
parser.add_argument('--dataset',  type=str, default='SUN-SEG')
...
parser.add_argument('--pvtv2_pretrained', default=False,
...
if __name__ == '__main__':
    ...
    for pth_path in pthList:
        save_root = './res/eval2/{}/{}/{}/'.format(pth_path.split('/')[-1][:-4],opt.dataset,opt.testsplit)
        # pdb.set_trace()
